...
def special(char_name: str, char_class: str) -> str:
    """Возвращает результат использования ульты."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Управляет тренировкой до её ручного завершения."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Конфигуратор персонажа: принимает выбранные имя и класс."""
    approve_choice: str = ''
    char_class: str = ''
